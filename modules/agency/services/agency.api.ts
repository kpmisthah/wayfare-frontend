...
export const fetchAgency = async ()=> {
    try {
        ...
        console.log(response,'fetch agency from agency profile nokan');
...
export const createAgency = async (agency:{description:string|null,specialization:string[],address:string,licenseNumber:string,ownerName:string,websiteUrl:string}) =>{
    try {
