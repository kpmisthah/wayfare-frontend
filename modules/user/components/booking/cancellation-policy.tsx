      ...
      <div className="space-y-3 text-sm text-gray-600">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p>Cancel up to 24 hours before the trip for a full refund</p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p>Cancel 12-24 hours before: 50% refund of total amount</p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p>Cancel less than 12 hours before: No refund available</p>
          </div>
        </div>
